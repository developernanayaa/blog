    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="has_sub">
                    <a href="<?php echo e(url(route('article.index'))); ?>" class="waves-effect"><i class="fa fa-home"></i> <span> Home </span> </a>
                </li>
                ...
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="<?php echo e(url(route('article.create'))); ?>">Create new</a></li>
                        <li><a href="<?php echo e(url(route('article.index'))); ?>">View All Articles</a></li>
